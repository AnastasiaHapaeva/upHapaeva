/**
 * Created by Анастасия on 13.03.2016.
 */
var id = 0;
var username = "User1";
var historyMes = [];
...
function updateInfo(newUserName){
    document.getElementsByClassName("userName").innerHTML=newUserName;
}
function changeName() {
